...
\f\r"'\`<>=]|("|')|))|$)`,"g"),vt=/'/g,xt=/"/g,Nt=/^(?:script|style|textarea|title)$/i,Gt=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),l=Gt(1),U=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),$t=new WeakMap,k=S.createTreeWalker(S,129,null,!1);function Lt(r,t){if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return mt!==void 0?mt.createHTML(t):t}const Wt=(r,t)=>{const e=r.length-1,i=[];let s,o=t===2?"<svg>":"",n=T;for(let c=0;c<e;c++){const a=r[c];let d,u,m=-1,g=0;for(;g<a.length&&(n.lastIndex=g,u=n.exec(a),u!==null);)g=n.lastIndex,n===T?u[1]==="!--"?n=ft:u[1]!==void 0?n=gt:u[2]!==void 0?(Nt.test(u[2])&&(s=RegExp("</"+u[2],"g")),n=C):u[3]!==void 0&&(n=C):n===C?u[0]===">"?(n=s??T,m=-1):u[1]===void 0?m=-2:(m=n.lastIndex-u[2].length,d=u[1],n=u[3]===void 0?C:u[3]==='"'?xt:vt):n===xt||n===vt?n=C:n===ft||n===gt?n=T:(n=C,s=void 0);const y=n===C&&r[c+1].startsWith("/>")?" ":"";o+=n===T?a+Jt:m>=0?(i.push(d),a.slice(0,m)+nt+a.slice(m)+E+y):a+E+(m===-2?(i.push(void 0),c):y)}return[Lt(r,o+(r[e]||"<?>")+(t===2?"</svg>":"")),i]};class B{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,n=0;const c=t.length-1,a=this.parts,[d,u]=Wt(t,e);if(this.el=B.createElement(d,i),k.currentNode=this.el.content,e===2){const m=this.el.content,g=m.firstChild;g.remove(),m.append(...g.childNodes)}for(;(s=k.nextNode())!==null&&a.length<c;){if(s.nodeType===1){if(s.hasAttributes()){const m=[];for(const g of s.getAttributeNames())if(g.endsWith(nt)||g.startsWith(E)){const y=u[n++];if(m.push(g),y!==void 0){const Tt=s.getAttribute(y.toLowerCase()+nt).split(E),D=/([.?@])?(.*)/.exec(y);a.push({type:1,index:o,name:D[2],strings:Tt,ctor:D[1]==="."?Kt:D[1]==="?"?Xt:D[1]==="@"?te:q})}else a.push({type:6,index:o})}for(const g of m)s.removeAttribute(g)}if(Nt.test(s.tagName)){const m=s.textContent.split(E),g=m.length-1;if(g>0){s.textContent=P?P.emptyScript:"";for(let y=0;y<g;y++)s.append(m[y],R()),k.nextNode(),a.push({type:2,index:++o});s.append(m[g],R())}}}else if(s.nodeType===8)if(s.data===kt)a.push({type:2,index:o});else{let m=-1;for(;(m=s.data.indexOf(E,m+1))!==-1;)a.push({type:7,index:o}),m+=E.length-1}o++}}static createElement(t,e){const i=S.createElement("template");return i.innerHTML=t,i}}function M(r,t,e=r,i){var s,o,n,c;if(t===U)return t;let a=i!==void 0?(s=e._$Co)===null||s===void 0?void 0:s[i]:e._$Cl;const d=I(t)?void 0:t._$litDirective$;return(a==null?void 0:a.constructor)!==d&&((o=a==null?void 0:a._$AO)===null||o===void 0||o.call(a,!1),d===void 0?a=void 0:(a=new d(r),a._$AT(r,e,i)),i!==void 0?((n=(c=e)._$Co)!==null&&n!==void 0?n:c._$Co=[])[i]=a:e._$Cl=a),a!==void 0&&(t=M(r,a._$AS(r,t.values),a,i)),t}class Yt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:i},parts:s}=this._$AD,o=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:S).importNode(i,!0);k.currentNode=o;let n=k.nextNode(),c=0,a=0,d=s[0];for(;d!==void 0;){if(c===d.index){let u;d.type===2?u=new V(n,n.nextSibling,this,t):d.type===1?u=new d.ctor(n,d.name,d.strings,this,t):d.type===6&&(u=new ee(n,this,t)),this._$AV.push(u),d=s[++a]}c!==(d==null?void 0:d.index)&&(n=k.nextNode(),c++)}return k.currentNode=S,o}v(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class V{constructor(t,e,i,s){var o;this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cp=(o=s==null?void 0:s.isConnected)===null||o===void 0||o}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=M(this,t,e),I(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==U&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):qt(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==f&&I(this._$AH)?this._$AA.nextSibling.data=t:this.$(S.createTextNode(t)),this._$AH=t}g(t){var e;const{values:i,_$litType$:s}=t,o=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=B.createElement(Lt(s.h,s.h[0]),this.options)),s);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===o)this._$AH.v(i);else{const n=new Yt(o,this),c=n.u(this.options);n.v(i),this.$(c),this._$AH=n}}_$AC(t){let e=$t.get(t.strings);return e===void 0&&$t.set(t.strings,e=new B(t)),e}T(t){St(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new V(this.k(R()),this.k(R()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,e);t&&t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class q{constructor(t,e,i,s,o){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=f}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,s){const o=this.strings;let n=!1;if(o===void 0)t=M(this,t,e,0),n=!I(t)||t!==this._$AH&&t!==U,n&&(this._$AH=t);else{const c=t;let a,d;for(t=o[0],a=0;a<o.length-1;a++)d=M(this,c[i+a],e,a),d===U&&(d=this._$AH[a]),n||(n=!I(d)||d!==this._$AH[a]),d===f?t=f:t!==f&&(t+=(d??"")+o[a+1]),this._$AH[a]=d}n&&!s&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Kt extends q{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}}const Qt=P?P.emptyScript:"";class Xt extends q{constructor(){super(...arguments),this.type=4}j(t){t&&t!==f?this.element.setAttribute(this.name,Qt):this.element.removeAttribute(this.name)}}class te extends q{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){var i;if((t=(i=M(this,t,e,0))!==null&&i!==void 0?i:f)===U)return;const s=this._$AH,o=t===f&&s!==f||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==f&&(s===f||o);o&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;typeof this._$AH=="function"?this._$AH.call((i=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&i!==void 0?i:this.element,t):this._$AH.handleEvent(t)}}class ee{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){M(this,t)}}const bt=z.litHtmlPolyfillSupport;bt==null||bt(B,V),((Q=z.litHtmlVersions)!==null&&Q!==void 0?Q:z.litHtmlVersions=[]).push("2.8.0");const ie=(r,t,e)=>{var i,s;const o=(i=e==null?void 0:e.renderBefore)!==null&&i!==void 0?i:t;let n=o._$litPart$;if(n===void 0){const c=(s=e==null?void 0:e.renderBefore)!==null&&s!==void 0?s:null;o._$litPart$=n=new V(t.insertBefore(R(),c),c,void 0,e??{})}return n._$AI(r),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var it;((it=window.HTMLSlotElement)===null||it===void 0?void 0:it.prototype.assignedElements)!=null;function Pt(r,t,e){const i=Array.from(r);let s;if(t==="")return s=i.filter(n=>n.kind==="file"),e?s:[s[0]];const o=t.toLowerCase().split(",").map(n=>n.split("/").map(c=>c.trim())).filter(n=>n.length===2);return s=s=i.filter(n=>{if(n.kind!=="file")return!1;const[c,a]=n.type.toLowerCase().split("/").map(d=>d.trim());for(const[d,u]of o)if(c===d&&(u==="*"||a===u))return!0;return!1}),e===!1&&(s=[s[0]]),s}function _t(r,t,e){const i=[];return Pt(r.items,t,e).forEach(s=>{const o=s.getAsFile();o!==null&&i.push(o)}),i}class J extends Event{constructor(t,e){var i,s;super(t,e),(i=this)instanceof(s=J)||Object.setPrototypeOf(i,s.prototype),this._files=e.files,this._action=e.action}get action(){return this._action}get files(){return this._files}}class ne extends HTMLElement{constructor(){super(),this._dragEnterCount=0,this._onDragEnter=this._onDragEnter.bind(this),this._onDragLeave=this._onDragLeave.bind(this),this._onDrop=this._onDrop.bind(this),this._onPaste=this._onPaste.bind(this),this.addEventListener("dragover",t=>t.preventDefault()),this.addEventListener("drop",this._onDrop),this.addEventListener("dragenter",this._onDragEnter),this.addEventListener("dragend",()=>this._reset()),this.addEventListener("dragleave",this._onDragLeave),this.addEventListener("paste",this._onPaste)}get accept(){return this.getAttribute("accept")||""}set accept(t){this.setAttribute("accept",t)}get multiple(){return this.getAttribute("multiple")}set multiple(t){this.setAttribute("multiple",t||"")}_onDragEnter(t){if(this._dragEnterCount+=1,this._dragEnterCount>1)return;if(t.dataTransfer===null)return void this.classList.add("drop-invalid");const e=Pt(t.dataTransfer.items,this.accept,this.multiple!==null);this.classList.add(!t.dataTransfer||!t.dataTransfer.items.length||e[0]!==void 0?"drop-valid":"drop-invalid")}_onDragLeave(){this._dragEnterCount-=1,this._dragEnterCount===0&&this._reset()}_onDrop(t){if(t.preventDefault(),t.dataTransfer===null)return;this._reset();const e=_t(t.dataTransfer,this.accept,this.multiple!==null);e!==void 0&&this.dispatchEvent(new J("filedrop",{action:"drop",files:e}))}_onPaste(t){if(!t.clipboardData)return;const e=_t(t.clipboardData,this.accept,this.multiple!==void 0);e!==void 0&&this.dispatchEvent(new J("filedrop",{action:"paste",files:e}))}_reset(){this._dragEnterCount=0,this.classList.remove("drop-valid"),this.classList.remove("drop-invalid")}}customElements.define("file-drop",ne);const oe=l`<svg viewBox="0 0 859 236" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
        ...
        fill="#362D31"
    />
</svg>`,ae=l`<svg viewBox="0 0 859 236" fill="none" xmlns="http://www.w3.org/2000/svg">
